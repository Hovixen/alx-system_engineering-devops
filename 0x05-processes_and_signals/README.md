...
This project completed for **Full Stack Software Engineering** given by **ALX_SE**. It aims to learn about PID, processes and commands that handles them (`ps`, `pgrep`, `pkill`, `kill`, etc) in **Bash**.
